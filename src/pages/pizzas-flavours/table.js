  ...
  return (
    <TableContainer>
      <TableTitleContainer>
        ...
        <Grid item>
          <TableButton color='primary' startIcon={<Add />} component={Link} to={`${PIZZAS_FLAVOURS}${NEW}`} disabled={!!newFlavourPath}>
          ...
          {pizzasFlavours?.map(pizza => (
            <TableRow key={pizza.id}>
              ...
              <TableCell align='right'>
                <TableButton startIcon={<Edit />} component={Link} to={`${PIZZAS_FLAVOURS}${EDIT(pizza.id)}`}>
                  Editar
                </TableButton>
